...
tokenizer = AutoTokenizer.from_pretrained(MODEL_PATH['qwen'],trust_remote_code=True, resume_download=True,)
...
if __name__ == "__main__":
    ...
    # 将JSON数据集写入到文件中
    with open('//home/wuyuan/workplace/lcx/autodl-tmp/go/labdata/process/qwen_buchong.json', 'w', encoding='utf-8') as json_file:
        json.dump(json_data, json_file, ensure_ascii=False, indent=4)
    
    print('JSON数据集已生成并保存到qwen_buchong.json文件中。')
